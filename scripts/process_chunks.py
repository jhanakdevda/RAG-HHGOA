"""
Process Dataset Chunks — Batch processing script for Phase 4

Reads data/sample/msmarco_xi_hi_sample.jsonl, applies AdaptiveSemanticChunker,
and writes chunk records to data/processed/msmarco_xi_hi_chunks.jsonl.
"""
...
INPUT_PATH = os.path.join("data", "sample", "msmarco_xi_hi_sample.jsonl")
OUTPUT_PATH = os.path.join("data", "processed", "msmarco_xi_hi_chunks.jsonl")
...
def process_chunks():
    ...
    print(f"Processing sample records from '{INPUT_PATH}'...")
    ...
    print("=" * 60)
    print("Phase 4 Chunk Processing Summary")
    print("=" * 60)
